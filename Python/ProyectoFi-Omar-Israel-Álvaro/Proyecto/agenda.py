...
def menu_agenda():
    def crearVentana():
        ...
        def remove_note():
            ...
            etiqueta4=tkinter.Label(ventana2, text = "Introduzca la nota a eliminar: ", bg="royal blue", fg="gold", font=25)      #Etiqueta de texto de la funcion remove, con color, fondo y fuente
            ...
            boton_remove=tkinter.Button(ventana2, text = "Eliminar", bg="steel blue", fg="gold", font=20, command=remove)     #Boton Eliminar, llamada a funcion remove(), con color, fondo y fuente
            boton_remove.pack()
        ...
        boton3=tkinter.Button(ventana2, text = "Una", bg="blue", fg="gold", padx=25, pady=15, command=remove_note, font=10)   #Boton Una, llamada a funcion remove_note(), con color, fondo y fuente
        boton3.place(x=100,y=250)      #Situar el boton en la ventana (en este caso, izquierda)

        boton4=tkinter.Button(ventana2, text = "Todas", bg="blue", fg="gold", padx=25, pady=15, command=remove_allNotes, font=10)     #Boton Todas, llamada a funcion remove_allNotes(), con color, fondo y fuente
    ...
    def main():
        ...
        etiqueta=tkinter.Label(ventana, text = "¿Quiere añadir o eliminar notas?", bg="midnight blue", fg="gold", font=("Helvatica",17,"bold"))
        ...
        def add_note():
            ...
            etiqueta4=tkinter.Label(ventana, text = "Introduzca la nota a añadir: ", bg="royal blue", fg="gold", font=25)
            ...
            boton_add=tkinter.Button(ventana, text = "Añadir", bg="steel blue", fg="gold", font=20,command=add)
            boton_add.pack()
        ...
        boton1=tkinter.Button(ventana, text = "Añadir", bg="blue", fg="gold", padx=25, pady=15, command=add_note, font=15)        #Boton Añadir, llamada a funcion remove_note(), con color, fondo y fuente
        boton1.place(x=100,y=250)      #Situar el boton en la ventana (en este caso, izquierda)

        boton2=tkinter.Button(ventana, text = "Eliminar", bg="blue", fg="gold", padx=25, pady=15, command=crearVentana, font=15)      #Boton Eliminar, llamada a funcion crearVentana(), que crea la ventana con las dos posibilidades de eliminar notas; con color, fondo y fuente
